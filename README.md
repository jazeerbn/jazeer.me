...
- **Performance**: Near-perfect Lighthouse scores thanks to Astro's "zero-JS" approach.
- **Theming**: Light and dark mode support.
- **SEO**: Fully responsive with automated OG image generation for social sharing.
- **Content**: Written in Markdown/MDX for easy portability.
